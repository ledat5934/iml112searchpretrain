    ...
    def __init__(
        ...
        try:
            if isinstance(research_cfg, dict):
                ...
                phase_cfg.diagnosis_enabled = bool(research_cfg.get("diagnosis_enabled", phase_cfg.diagnosis_enabled))
                ...
                phase_cfg.diagnosis_enabled = bool(getattr(research_cfg, "diagnosis_enabled", phase_cfg.diagnosis_enabled))
