...
- "task_type": One of ["text_classification","image_classification","tabular_classification","tabular_regression","audio_classification","video_classification","object_detection","segmentation","speech_recognition","time_series_forecasting","pairwise_classification","seq2seq","ner","qa","unknown"] inferred from the description and directory structure.
